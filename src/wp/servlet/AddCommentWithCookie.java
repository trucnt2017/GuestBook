...
public class AddCommentWithCookie extends HttpServlet {
    ...
    //Hàm duyệt và tìm cookie tương ứng với name
    private String getUsernameFromCookie(HttpServletRequest request)
    {
    	//Duyệt trong mảng Cookie khác rỗng thì duyệt qua và tìm cookie có name cần lấy
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<form action='AddCommentWithCookie' method='Post'>");
		//Nếu đã có name trong cookie thì chỉ cần display name
